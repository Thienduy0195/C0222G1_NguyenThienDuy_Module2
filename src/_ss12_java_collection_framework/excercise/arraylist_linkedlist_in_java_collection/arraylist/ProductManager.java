...
public class ProductManager {
    ...
    static {
        ...
        arrList.add(new Product("Panasonic", "PN", 6000)) ;
        arrList.add(new Product("Iphone", "IP", 8000)) ;
        arrList.add(new Product("Blackberry", "BL", 6000)) ;
        arrList.add(new Product("HTC", "HTC", 4500)) ;
    }
    ...
    public void addProduct() {
        ...
        arrList.add( new Product(name, id, price));
